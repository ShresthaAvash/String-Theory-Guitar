                ...
                <c:when test="${not empty guitar}">
                    <div class="product-detail-layout">
                        <div class="product-image-column">
                            <div class="main-product-image">
                                <c:choose>
                                    <c:when test="${not empty guitar.mainImageUrl}">
                                        <img id="mainImageDisplay" src="${fn:escapeXml(guitar.mainImageUrl)}" alt="${fn:escapeXml(guitar.brand)} ${fn:escapeXml(guitar.model)} main image">
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <%-- Thumbnail gallery logic removed as per single mainImageUrl approach --%>
                        </div>
